  ...
  >
    ...
    >
      ...
      <div
        :class="
          wrapType === 'dialog'
            ? 'mu-alert-foot text-center'
            : 'modal-footer mu-dialog-foot text-center'
        "
      >
        <!-- 초기화 -->
        <b-btn
...
export default {
  ...
  methods: {
    ...
    setModalComponent(componentObj) {
      ...
      // 사용하지 않는 경우만 값을 보냄.
      this.useSaveBtn =
        componentObj.btnName.useSaveBtn === undefined
          ? true
          : componentObj.btnName.useSaveBtn;
      this.useCancelBtn =
        componentObj.btnName.useCancelBtn === undefined
          ? true
          : componentObj.btnName.useCancelBtn;

      // 사용하는 경우만 값을 보냄
      this.useResetBtn =
        componentObj.btnName.useResetBtn === undefined
          ? false
          : componentObj.btnName.useResetBtn;
